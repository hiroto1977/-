...
npm run lint:shared-judgement # 「述語は共有したが、no と言われたあとの動作が両ビルドで
                           ...
                           #   生成ブロックと突き合わせる (shared 145 / 両ビルドが
                           #   import 63 / うち否定で答えられる 32。**この 3 つは
