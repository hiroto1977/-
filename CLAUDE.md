...
npm run lint:shared-judgement # 「述語は共有したが、no と言われたあとの動作が両ビルドで
                           ...
                           #   生成ブロックと突き合わせる (shared 143 / 両ビルドが
                           #   import 62 / うち否定で答えられる 31。**この 3 つは
