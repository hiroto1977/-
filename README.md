...
<!-- SERVICES:START (auto-generated by scripts/sync-readme.cjs — do not edit by hand) -->
## サービス一覧 (45)

| カテゴリ | サービス |
|---|---|
| **おすすめ** (6) | ホーム / 事業ダッシュボード / チームレーダー / テンプレート / ライブラリ / 設定 |
| **分析・ツール** (13) | Skills / Security / Cloudflare / Emotions / Ollama / KPI / BEP / Stocks / Uber Eats / 出前館 / 不動産投資 / 投資信託 / 品質ダッシュボード / ストレージ最適化 |
...
npm run mutate            # Stryker mutation testing (55 modules, 100%)
npm run smoke             # xvfb + Electron で全ページ smoke screenshot
```
...
| unit tests (`vitest`) | 1253 / 1253 ✅ |
| eslint | 0 errors |
| lint:imports | 433 imports, 全境界 OK |
| lint:forbidden | 8 patterns scanned, 全 clean |
| lint:test-coverage | 45 services, 全 test 存在 |
| verify:arch | 171 file:line refs + 6 metrics 一致 |
| mutation (Stryker) | **100.00%** (55 modules) |

## ドキュメント

- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — 全体設計 + 45 services 認証マトリクス
