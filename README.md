...
| **分析・ツール** (19) | Skills / Security / Cloudflare / Emotions / Ollama / KPI / Stocks / 不動産投資 / 投資信託 / 品質ダッシュボード / ストレージ最適化 / 税務試算 / 資金調達レーダー / コネクター / Linux / コンプライアンス / Obsidian / Docker / 可視化 |
...
ほかに Uber Eats / 出前館 (サイドバー非表示 — 事業ダッシュボードのフードデリバリー欄へ統合) を含め全 74 サービス。
