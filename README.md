...
| **外部サービス連携** (37) | GitHub / WordPress.com / Atlassian / Notion / Google Drive / Google Calendar / Gmail / Slack / Canva / Microsoft 365 / Dropbox / Salesforce / Discord / Asana / Linear / Sentry / Shopify / Stripe / LINE / 税理士 / 社労士 / 弁護士 / 司法書士 / 行政書士 / 中小企業診断士 / 弁理士 / BASE / NETSEA / スーパーデリバリー / TopSeller / A8.net / AIブログくん / マネーフォワード / Amazon / Amazon アソシエイト / YouTube / ココナラ |
...
npm run smoke             # xvfb + Electron で 59 ページ smoke screenshot
```
...
src/main/              ← Electron main process
  ...
  clients/               59 sub-clients (各 service の REST fetcher + actions)
...
src/renderer/          ← React app
  ...
  data/snapshot.ts       全 59 サービスの bundled 静的データ
```
...
| lint:test-coverage | 59 services, 全 test 存在 |
