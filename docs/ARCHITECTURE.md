...
| ユニットテスト | **457** | `npm test` |
| Mutation score (total) | **94.55%** | `docs/QUALITY.md` |
| Mutation score (covered) | **96.22%** | `docs/QUALITY.md` |
| Stryker break threshold | **94%** (CI fails below) | `stryker.config.json` |
