...
| ユニットテスト | **444** | `npm test` |
| Mutation score (total) | **91.45%** | `docs/QUALITY.md` |
| Mutation score (covered) | **93.20%** | `docs/QUALITY.md` |
| Stryker break threshold | **91%** (CI fails below) | `stryker.config.json` |
