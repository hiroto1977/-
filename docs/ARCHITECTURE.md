...
| ユニットテスト | **446** | `npm test` |
| Mutation score (total) | **92.09%** | `docs/QUALITY.md` |
| Mutation score (covered) | **93.85%** | `docs/QUALITY.md` |
| Stryker break threshold | **91.5%** (CI fails below) | `stryker.config.json` |
