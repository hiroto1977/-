...
| ユニットテスト | **567** | `npm test` |
| Mutation score (total) | **98.07%** | `docs/QUALITY.md` |
| Mutation score (covered) | **98.46%** | `docs/QUALITY.md` |
| Stryker break threshold | **97.5%** (CI fails below — iterating stocks.ts back to 99) | `stryker.config.json` |
