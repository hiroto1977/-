...
| ユニットテスト | **443** | `npm test` |
| Mutation score (total) | **90.73%** | `docs/QUALITY.md` |
| Mutation score (covered) | **92.46%** | `docs/QUALITY.md` |
| Stryker break threshold | **90.5%** (CI fails below) | `stryker.config.json` |
