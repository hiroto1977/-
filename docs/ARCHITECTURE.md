...
| ユニットテスト | **570** | `npm test` |
| Mutation score (total) | **99.13%** | `docs/QUALITY.md` |
| Mutation score (covered) | **99.45%** | `docs/QUALITY.md` |
| Stryker break threshold | **99%** (CI fails below — pre-stocks ratchet restored) | `stryker.config.json` |
