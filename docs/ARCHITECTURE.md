...
| ユニットテスト | **569** | `npm test` |
| Mutation score (total) | **98.48%** | `docs/QUALITY.md` |
| Mutation score (covered) | **98.86%** | `docs/QUALITY.md` |
| Stryker break threshold | **98%** (CI fails below — iterating stocks.ts back to 99) | `stryker.config.json` |
