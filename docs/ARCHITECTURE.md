...
| ユニットテスト | **556** | `npm test` |
| Mutation score (total) | **96.25%** | `docs/QUALITY.md` |
| Mutation score (covered) | **96.55%** | `docs/QUALITY.md` |
| Stryker break threshold | **95%** (CI fails below — iterating stocks.ts back to 99) | `stryker.config.json` |
