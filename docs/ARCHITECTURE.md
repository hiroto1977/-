...
| ユニットテスト | **448** | `npm test` |
| Mutation score (total) | **92.43%** | `docs/QUALITY.md` |
| Mutation score (covered) | **94.05%** | `docs/QUALITY.md` |
| Stryker break threshold | **92%** (CI fails below) | `stryker.config.json` |
