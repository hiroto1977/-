...
| ユニットテスト | **573** | `npm test` |
| Mutation score (total) | **99.62%** | `docs/QUALITY.md` |
| Mutation score (covered) | **100.00%** | `docs/QUALITY.md` |
| Stryker break threshold | **99.5%** (CI fails below — every covered mutant killed across all 11 files) | `stryker.config.json` |
