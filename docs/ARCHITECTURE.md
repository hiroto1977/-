...
| ユニットテスト | **406** | `npm test` |
| Mutation score (total) | **88.88%** | `docs/QUALITY.md` |
| Mutation score (covered) | **89.85%** | `docs/QUALITY.md` |
| Stryker break threshold | **88%** (CI fails below) | `stryker.config.json` |
