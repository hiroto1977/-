...
実装規模: **1193 静的 it() / 1242 実行時 tests · 45 client modules · 11 IPC handlers ·
...
| 7 | ユニットテスト | `vitest run` | 1242 件のうち 1 つでも fail |
...
**現状値**: 1193 静的 `it()` / 1242 実行時 tests passing · Stryker mutation **100.00%** ·
...
| **PR #9 (現在)** | **45** | **45+** | **1193 / 1242** | **100.00%** | **99.8** | **DRY refactor (-685 行)** |
...
PR #9 完了時点で:
- 45 services / 1242 tests / 100% mutation / 171 refs / 4 cross-doc facts が CI で
  自動検証
