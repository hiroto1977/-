...
> **進捗:** 1940–1993 収録済み（戦時〜高度成長〜石油危機〜安定成長〜プラザ合意〜バブル絶頂・崩壊〜複合不況）。日経平均の年末値は1975・1978・1979・1982・1986・1987に加え、1988（30,159）・1989（38,915.87 史上最高値）・1990（23,848）・1991（22,983.77）・1992（16,924）を独立2源以上で確証して収録（1993は集約サイトが一律403で二重確認できずnull、他年は一次データ未照合のためnull）。以降、平成不況〜デフレ期（1994–）以降を1年ずつ継続採録する。
