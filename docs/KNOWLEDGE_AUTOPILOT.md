...
知識ベース（学術 3,625 / 法令実務 402 / 補助金 140 / 経済史 86 / 相談窓口 3 = 4,256 項目）を
...
| **REGEN** | 派生成果物を再生成: Obsidian vault（4,397 ノート）+ NotebookLM エクスポート（17 パート） |
...
| `missingAsOf` | 項目別 asOf を持たないコレクション（現状: 経済史 86 件） | データ側に asOf を一括付与する 1 回のタスク |
