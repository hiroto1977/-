...
- [x] 知識コーパス **4,171 項目**（学術 3,549 / 法令実務 393 / 補助金 140 / 経済史 86 / 相談窓口 3）
      + Obsidian vault 7,584 ノート + knowledge-graph（nodes 4,171 / edges 20,916）
- [x] 重複疑いキュー **3 系列すべて 0 件** / 出典ベースライン **0 件**

未完了の主要タスク（優先度順）:
- [ ] **知識コーパスの増強バックログ 389 件**（学術 389 / 法令実務 0 — 完走）
