...
- [x] 知識コーパス **4,158 項目**（学術 3,536 / 法令実務 393 / 補助金 140 / 経済史 86 / 相談窓口 3）
      + Obsidian vault 7,561 ノート + knowledge-graph（nodes 4,158 / edges 20,848）
- [x] 重複疑いキュー **3 系列すべて 0 件** / 出典ベースライン **0 件**

未完了の主要タスク（優先度順）:
- [ ] **知識コーパスの増強バックログ 364 件**（学術 364 / 法令実務 0 — 完走）
