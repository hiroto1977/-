...
- [x] 知識コーパス **4,148 項目**（学術 3,526 / 法令実務 393 / 補助金 140 / 経済史 86 / 相談窓口 3）
      + Obsidian vault 7,548 ノート + knowledge-graph（nodes 4,148 / edges 20,896）
- [x] 重複疑いキュー **3 系列すべて 0 件** / 出典ベースライン **0 件**

未完了の主要タスク（優先度順）:
- [ ] **知識コーパスの増強バックログ 233 件**（学術 233 / 法令実務 0 — 完走）
