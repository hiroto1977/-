...
| **Knowledge Vault** | 7,605 files（知識 4,185＋人物・出典・年表・パス・教育・MOC/組織。統合パス4/5/7/8/9/10/11/12/13/14 で 48 概念分のノートが統合先へ吸収。パス6 の出典差し替えで出典ノートが再編） |
