...
| 項目 | 値 |
|---|---|
| **現在の概念総数** | **3,557**（`grep -c "    id: '" src/renderer/data/academicKnowledge.ts`。重複統合 12 パス+オートパイロット消化で 4,350→3,557・**−793**。パス4/5/7 は全文読解で裁定し、統合先の出典・記述を一切減らさずに 25 件を統合。**重複疑いキューは 3 系列すべて 0 件** — タイトルコア一致 / グラフ term-overlap / **id 正規化 (パス7 で新設)**） |
...
| **Knowledge Vault** | 7,596 files（知識 4,179＋人物・出典・年表・パス・教育・MOC/組織。統合パス4〜15 で 54 概念分のノートが統合先へ吸収。パス6 の出典差し替えで出典ノートが再編） |
