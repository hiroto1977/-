...
tags:
  ...
  - knowledge/verified
aliases:
  - "不当条項無効法理（コモン・ロー）：手続的・実質的不当性の二段テストによる一方的契約条項の裁判的制限"
---
...
## 提唱者・初出
カール・ルウェリン ／ J・スケリー・ライト ／ アーサー・アレン・レフ

## 出典
- [Williams v. Walker-Thomas Furniture Co. 350 F.2d 445 D.C. Cir. 1965 — Procedural and Substantive Unconscionability Test](https://law.justia.com/cases/federal/appellate-courts/F2/350/445/74531/) `公的`
- [Cornell LII 2024 — Uniform Commercial Code §2-302 Unconscionable Contract or Clause with Official Comments](https://www.law.cornell.edu/ucc/2/2-302) `リファレンス`
- [Leff 1967 — Unconscionability and the Code: The Emperor's New Clause, University of Pennsylvania Law Review 115:485-559](https://scholarship.law.upenn.edu/penn_law_review/vol115/iss4/1/) `学術`
