...
tags:
  ...
  - knowledge/verified
aliases:
  - "逆選択とレモン市場（アカロフ）——取引前の情報の非対称性で質の悪い財や高リスクの相手ばかりが市場に残り、市場が縮小・崩壊する"
---
...
## 提唱者・初出
ジョージ・アカロフ（1970『The Market for "Lemons"』QJE／2001 ノーベル経済学賞）／対比: マイケル・スペンス（シグナリング）／ジョセフ・スティグリッツ（スクリーニング）

## 出典
- [Akerlof, G. A. (1970) The Market for "Lemons": Quality Uncertainty and the Market Mechanism — Quarterly Journal of Economics 84(3), 488–500（原論文）](https://doi.org/10.2307/1879431) `学術`
- [Oxford Academic — The Market for "Lemons" (1970) 論文ページ](https://academic.oup.com/qje/article-abstract/84/3/488/1896241) `学術`
- [NobelPrize.org — The 2001 Prize in Economic Sciences, Popular information（レモン市場・逆選択・市場崩壊の解説）](https://www.nobelprize.org/prizes/economic-sciences/2001/popular-information/) `リファレンス`
- [Britannica Money — Adverse selection（定義と保険・信用市場の例）](https://www.britannica.com/money/adverse-selection) `リファレンス`
