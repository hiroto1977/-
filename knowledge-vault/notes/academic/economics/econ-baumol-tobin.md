...
## 提唱者・初出
ウィリアム・ボーモル（1952）／ジェームズ・トービン（1956）

## 出典
- [Wikipedia: Baumol–Tobin model（取引需要・平方根法則・Baumol 1952 / Tobin 1956）](https://en.wikipedia.org/wiki/Baumol%E2%80%93Tobin_model) `リファレンス`
- [国立台湾大学 講義ノート: Baumol-Tobin Model（最適貨幣残高 √(2bY/r) の導出）](https://homepage.ntu.edu.tw/~nankuang/Baumol-Tobin%20Model.pdf) `学術`
- [一橋大学大学院経営管理研究科 みずほ証券寄附講義「在庫理論アプローチ」（所得・金利・取引コスト依存）](https://hub-mhsc.com/research_notes/research_notes-987/) `学術`
