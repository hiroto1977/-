...
tags:
  ...
  - knowledge/verified
aliases:
  - "くもの巣モデル（コブウェブ定理）——生産の遅れと素朴な期待が農産物価格の収束・発散・循環を生む動学モデル"
---
...
## 提唱者・初出
モーデカイ・エゼキエル（1938『The Cobweb Theorem』QJE）／ニコラス・カルドア（1934 命名・Review of Economic Studies）／ウンベルト・リッチ、ヤン・ティンバーゲン、ヘンリー・シュルツ（1930年前後に独立に定式化）／マーク・ネルローヴ（1958 適応的期待）／ジョン・ムース（1961 合理的期待による批判）／カーズ・ホンメス（異質的期待モデル）

## 出典
- [Ezekiel, M. (1938) The Cobweb Theorem — Quarterly Journal of Economics 52(2), 255–280（コブウェブ定理の原論文。図解による普及）](https://doi.org/10.2307/1881734) `学術`
- [Kaldor, N. (1934) A Classificatory Note on the Determinateness of Equilibrium — Review of Economic Studies（「くもの巣定理」の命名と安定条件の分類）](https://doi.org/10.2307/2296731) `学術`
- [Poitras, "Cobweb Theory, Market Stability, and Price Expectations" — Journal of the History of Economic Thought (Cambridge UP)（起源と期待形成をめぐる学説史）](https://www.cambridge.org/core/journals/journal-of-the-history-of-economic-thought/article/cobweb-theory-market-stability-and-price-expectations/EF014F2F0378CB5CE259E12E5CDD5C2D) `学術`
- [EconLib, Concise Encyclopedia of Economics: Cobweb Theorem（収束・発散条件と豚サイクルの解説）](https://www.econlib.org/library/Enc/CobwebTheorem.html) `リファレンス`
- [コトバンク「くもの巣理論」（平凡社 世界大百科事典ほか）](https://kotobank.jp/word/%E3%81%8F%E3%82%82%E3%81%AE%E5%B7%A3%E7%90%86%E8%AB%96-831121) `リファレンス`
- [Wikipedia: Cobweb model（傾き／弾力性による収束・発散条件と期待形成の概説）](https://en.wikipedia.org/wiki/Cobweb_model) `リファレンス`
