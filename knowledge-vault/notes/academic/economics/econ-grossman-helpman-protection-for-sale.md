...
tags:
  ...
  - knowledge/verified
aliases:
  - "保護の販売モデル（グロスマン＝ヘルプマン「Protection for Sale」）——貿易保護の政治経済学"
---
...
## 提唱者・初出
グロスマン, ジーン （1994年 Protection for Sale, American Economic Review 84(4): 833-850）／ヘルプマン, エルハナン （共著者）／バーンハイム, B・ダグラス （メニュー・オークション理論の基礎）／ウィンストン, マイケル （同）／ゴールドバーグ, ピネロピ （1999年 実証検証）／マッジ, ジョバンニ （同）

## 出典
- [Grossman & Helpman (1992/1994) "Protection for Sale," NBER Working Paper 4149（AER 84(4): 833-850として刊行）](https://www.nber.org/papers/w4149) `学術`
