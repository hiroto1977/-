...
tags:
  ...
  - knowledge/verified
aliases:
  - "ハルサーニの純化定理——混合戦略は私的情報に基づく確定的行動の極限である"
---
...
## 提唱者・初出
Harsanyi, John C.（1973 Games with Randomly Disturbed Payoffs: A New Rationale for Mixed-Strategy Equilibrium Points, International Journal of Game Theory／1994年ノーベル経済学賞）／Govindan, Srihari・Reny, Philip J.・Robson, Arthur J.（2003 A Short Proof of Harsanyi's Purification Theorem, Games and Economic Behavior）

## 出典
- [Harsanyi, J. C. (1973) Games with randomly disturbed payoffs: A new rationale for mixed-strategy equilibrium points — International Journal of Game Theory 2, 1–23](https://doi.org/10.1007/BF01737554) `学術`
