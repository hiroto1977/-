...
tags:
  ...
  - knowledge/verified
aliases:
  - "マスキンの遂行理論とマスキン単調性——ナッシュ均衡で社会的目標を実現できる条件"
---
...
## 提唱者・初出
エリック・マスキン（1999 マスキン単調性＝ナッシュ遂行の必要条件、単調性＋拒否権不在で十分性を証明）／レオニード・ハーヴィッツ（1972 メカニズム設計・誘因両立性の創始）／ジョン・ムーア＆ジョン・レプロ（1988 部分ゲーム完全遂行への拡張）／トマス・パルフリー＆サンジェイ・スリヴァスタヴァ（1987 ベイジアン遂行への一般化）
