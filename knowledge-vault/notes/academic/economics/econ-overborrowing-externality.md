...
tags:
  ...
  - knowledge/verified
aliases:
  - "過剰借入の外部性（Overborrowing Externality）"
---
...
## 提唱者・初出
Guido Lorenzoni（Review of Economic Studies 75(3), 2008 — 非効率的信用ブームモデル）／Javier Bianchi（American Economic Review 101(7), 2011 — 過剰借入とシステミック外部性の定量分析）
