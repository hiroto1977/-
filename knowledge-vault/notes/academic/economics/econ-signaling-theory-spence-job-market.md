...
tags:
  ...
  - knowledge/verified
aliases:
  - "シグナリング理論（スペンス）——情報を持つ側が模倣にコストのかかる行動で自らの質を伝え、分離均衡が成立する仕組み"
---
...
## 提唱者・初出
マイケル・スペンス（1973『Job Market Signaling』QJE／1974『Market Signaling』Harvard University Press／2001 ノーベル経済学賞）／ジョージ・アカロフ（1970 レモン市場）／ジョセフ・スティグリッツ（スクリーニング）／アンドリュー・ワイス（1995 人的資本説とシグナル説の識別）

## 出典
- [Spence, M. (1973) Job Market Signaling — Quarterly Journal of Economics 87(3), 355–374（シグナリング理論の原論文）](https://doi.org/10.2307/1882010) `学術`
- [Spence, M. (1974) Market Signaling: Informational Transfer in Hiring and Related Screening Processes — Harvard University Press（理論の展開）](https://www.hup.harvard.edu/books/9780674549906) `学術`
- [Akerlof, G. A. (1970) The Market for Lemons: Quality Uncertainty and the Market Mechanism — Quarterly Journal of Economics 84(3), 488–500（逆選択との関係）](https://doi.org/10.2307/1879431) `学術`
- [Weiss, A. (1995) Human Capital vs. Signalling Explanations of Wages — Journal of Economic Perspectives 9(4), 133–154（人的資本説との識別）](https://www.jstor.org/stable/2138873) `学術`
- [NobelPrize.org — The 2001 Prize in Economic Sciences, Popular information（シグナリングとスクリーニングの区別）](https://www.nobelprize.org/prizes/economic-sciences/2001/popular-information/) `リファレンス`
