...
tags:
  ...
  - knowledge/verified
aliases:
  - "シグナリング理論——スペンスの学歴シグナルと情報非対称性下の資格獲得行動"
---
...
## 概要
シグナリング理論（signaling theory）は，マイケル・スペンスが1973年の論文「労働市場のシグナリング」で提唱した，情報の非対称性が存在する市場において，情報を持つ側（求職者）が持たない側（雇用主）に自己の質を伝えるために「シグナル（signal）」を発信するという枠組みである。スペンスは大学教育を「生産性を高める投資」としてではなく，「高能力者が低能力者より低コストで取得できるシグナル」として分析し，均衡において高能力者は教育を取得し，低能力者は取得しないという「分離均衡」が成立することを示した（2001年ノーベル経済学賞）。シグナリングはアカーロフ・スティグリッツとともに情報経済学の三大理論（逆選択・シグナリング・スクリーニング）を構成する。就職活動・学歴社会・資格・保証・広告（コストリーシグナルとしての宣伝費）・ESGレーティングなど多様な応用を持つ。シグナリングの純粋なコスト面は社会的浪費を生じうるという批判もある。

## 提唱者・初出
マイケル・スペンス ／ ジョージ・アカロフ ／ ジョセフ・スティグリッツ ／ ジェームズ・ライリー

## 出典
- [Spence, M. (1973) Job Market Signaling — QJE](https://doi.org/10.2307/1882010) `学術`
- [Wikipedia: Signalling (economics) — information economics](https://en.wikipedia.org/wiki/Signalling_(economics)) `リファレンス`
