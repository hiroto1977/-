...
## 提唱者・初出
ドルフマン＝サミュエルソン＝ソロー（1958 命名・新古典的定式化）／ジョン・フォン・ノイマン（1945 均斉成長モデル）

## 出典
- [Turnpike Theory — Wikipedia](https://en.wikipedia.org/wiki/Turnpike_theory) `リファレンス`
