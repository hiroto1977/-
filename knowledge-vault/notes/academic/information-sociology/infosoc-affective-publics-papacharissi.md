---
collection: academic
id: infosoc-affective-publics-papacharissi
category: "information-sociology"
category_ja: "情報社会学"
title: "感情的公衆——デジタルメディアにおける情動的ネットワーク形成"
as_of: "2026-06-26"
source_count: 3
authoritative: true
tags:
...
## 概要
感情的公衆（affective publics）は、ジー・パパチャリッシが2015年の著書で提唱した概念であり、ソーシャルメディア上で情動的な表現と共有を通じて形成される一時的な公衆のネットワークを分析する枠組みである。従来のハーバーマス的公共圏論が理性的熟議を公衆の構成原理としたのに対し、パパチャリッシは感情（affect）と情動的つながりがデジタル空間における政治的動員と集合行為の基盤となることを論じた。アラブの春、オキュパイ運動、ブラック・ライブズ・マター等の事例分析を通じて、ハッシュタグ・ストーリーテリング・ライブ中継が情動的連帯を生成し、既存の政治制度や組織構造を迂回する新たな公衆の形態を可能にすることを示した。感情的公衆は常設の組織ではなく、特定のイシューやイベントを契機として凝集し、情動の衰退とともに解体する流動的な構造である。

## 提唱者・初出
ジー・パパチャリッシ ／ ユルゲン・ハーバーマス ／ サラ・アーメッド ／ ブライアン・マスミ

## 出典
- [Papacharissi, Z. (2015) Affective Publics: Sentiment, Technology, and Politics — Oxford University Press](https://doi.org/10.1093/acprof:oso/9780199999736.001.0001) `学術`
