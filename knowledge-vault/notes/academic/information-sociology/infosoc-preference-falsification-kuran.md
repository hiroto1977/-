...
tags:
  ...
  - knowledge/verified
aliases:
  - "選好偽装理論（preference falsification）——本音と建前の乖離が生む予測不能な体制転換"
---
...
## 提唱者・初出
クラン, ティムール（Kuran, Timur　1995『Private Truths, Public Lies: The Social Consequences of Preference Falsification』）／初出論文: Kuran (1989)「Sparks and Prairie Fires」Public Choice誌／関連概念: 選好偽装の閾値・革命的バンドワゴン・多元的無知

## 出典
- [Kuran, T. (1989) "Sparks and Prairie Fires: A Theory of Unanticipated Political Revolution", Public Choice 61(1), 41–74（理論の原典論文）](https://doi.org/10.1007/BF00116762) `学術`
- [Kuran, T. (1995) Private Truths, Public Lies: The Social Consequences of Preference Falsification, Harvard University Press（理論を体系化した原著書、出版元公式ページ）](https://www.hup.harvard.edu/books/9780674707580) `学術`
- [Wikipedia — Preference falsification（定義・私的/公的選好・革命的バンドワゴンの概説）](https://en.wikipedia.org/wiki/Preference_falsification) `リファレンス`
