...
tags:
  ...
  - knowledge/verified
aliases:
  - "監視資本主義（ズボフ）——人間の経験を無償の原材料として採取し、行動余剰を予測製品に加工して行動先物市場で売る資本主義の新しい論理"
---
...
## 提唱者・初出
ショシャナ・ズボフ（2015「Big Other」／2019『監視資本主義の時代』）／対比: ニック・スルニチェク（プラットフォーム資本主義）／コリン・ベネット＆ダニエル・ソロブ（概念の肥大化への批判）

## 出典
- [Zuboff, S. (2015) Big Other: Surveillance Capitalism and the Prospects of an Information Civilization — Journal of Information Technology 30(1)（原典）](https://doi.org/10.1057/jit.2015.5) `学術`
- [PublicAffairs: Zuboff, S. (2019) The Age of Surveillance Capitalism（概念の体系化）](https://www.publicaffairsbooks.com/titles/shoshana-zuboff/the-age-of-surveillance-capitalism/9781610395694/) `リファレンス`
- [Regulation (EU) 2016/679 (GDPR) — EUR-Lex（行動データ保護の立法）](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0679) `公的`
- [Wikipedia: Surveillance capitalism — Zuboff、behavioral surplus、行動先物市場、批判](https://en.wikipedia.org/wiki/Surveillance_capitalism) `リファレンス`
