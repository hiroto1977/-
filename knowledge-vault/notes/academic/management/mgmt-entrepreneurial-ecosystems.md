...
## 概要
アントレプレナーシップ・エコシステムとは、起業家・投資家・大学・政府・文化が相互作用し新規事業創出を支える地域的クラスターを指す。アイゼンバーグ（ハーバード、2010年）が政策フレームワークとして提唱し、フェルド（2012年『Startup Communities』）がボルダーモデルを実証。オートら（2014年）はシリコンバレー研究とポーターのクラスター理論を統合し、エコシステムの自己強化メカニズムを理論化した。
