...
tags:
  ...
  - knowledge/verified
aliases:
  - "VRIO フレームワーク（バーニー）——価値・希少性・模倣困難性・組織の四条件を満たす経営資源だけが持続的競争優位をもたらし、欠けるほど同等性や一時的優位にとどまる"
---
...
## 提唱者・初出
ジェイ・バーニー（1991 提唱）／マーガレット・ピーターラフ（1993 競争優位の礎石）／リチャード・ルメルト（隔離メカニズム）／エディス・ペンローズ＆バーガー・ワーナーフェルト（資源ベース論の源流）
