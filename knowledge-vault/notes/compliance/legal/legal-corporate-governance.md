...
## 概要
会社法上、株式会社は株主総会と取締役を必ず置かなければならず（会社法326条1項）、定款の定めや会社の規模・公開会社か否か等に応じて取締役会・監査役・監査役会・会計参与・会計監査人・監査等委員会・指名委員会等を設置する（同条2項）。公開会社（発行する全部の株式に譲渡制限のない会社）は取締役会を置かなければならず（327条1項）、取締役会設置会社は原則として監査役（又は監査等委員会・指名委員会等）を置く必要があり（327条2項）、大会社（資本金5億円以上又は負債200億円以上）は会計監査人を置かなければならない（328条）。

## 所管・根拠
所管: 法務省（会社法）

## 出典
- [e-Gov法令検索 会社法（326条〜328条）](https://laws.e-gov.go.jp/law/417AC0000000086) `公的`
- [法務局 株式会社の機関設計](https://houmukyoku.moj.go.jp/homu/content/001252678.pdf) `公的`
- [会社法 大会社の会計監査人設置義務 解説](https://www.ey.com/ja_jp/technical/corporate-accounting/commentary/companies-act/commentary-companies-act-2016-06-03-02) `メディア`
