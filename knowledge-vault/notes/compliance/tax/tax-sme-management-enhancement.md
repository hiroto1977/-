...
tags:
  ...
  - knowledge/verified
aliases:
  - "中小企業経営強化税制（経営力向上計画に基づく即時償却・税額控除）"
---
...
## 概要
中小企業等経営強化法に基づく「経営力向上計画」の認定を受けた中小企業者等が、その計画に従って一定の特定経営力向上設備等（生産性向上設備・収益力強化設備等）を取得・製作等した場合に、即時償却又は取得価額の一定割合の税額控除を選択適用できる制度（租税特別措置法第42条の12の4ほか）。計画認定や工業会証明書・経済産業局確認書を要する点で、設備導入のみで適用でき計画認定を前提としない「中小企業投資促進税制」とは別の制度である。控除率・対象設備類型・適用期限は税制改正により変動するため要確認。

## 所管・根拠
所管: 中小企業庁（経営強化法）・国税庁（税務上の取扱い）

## 出典
- [国税庁 No.5434 中小企業経営強化税制](https://www.nta.go.jp/taxes/shiraberu/taxanswer/hojin/5434.htm) `公的`
