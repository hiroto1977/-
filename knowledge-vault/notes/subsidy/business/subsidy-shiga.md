...
## 概要
滋賀県内の中小企業者等が経営革新計画等に基づき行う新商品開発・販路開拓・生産性向上等の取組を応援する滋賀県の代表的な補助制度の一例。補助率・上限額・対象経費・募集期間は年度・公募回ごとに変動するため、最新の募集要項及び県・商工団体の公式で要確認。

## 所管・実施機関
滋賀県（商工観光労働部 中小企業支援課）／連携: 地域の商工会議所・商工会
...
## 出典
- [滋賀県 中小企業支援](https://www.pref.shiga.lg.jp/ippan/shigotosangyou/chusyo/) `自治体`
