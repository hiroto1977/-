...
- [[econ-blanchard-quah-long-run-restrictions|ブランシャール＝クアの長期制約による構造VAR識別——需要ショックと供給ショックの分解]] — Faust,J.&Leeper,E.M.(1997)."WhenDoLong-RunIdentifyingRestrictionsGive…
...
- [[econ-rubin-causal-model-potential-outcomes|ルービン因果モデル（潜在結果枠組み）——処置と非処置を同時に観測できないという因果推論の根本問題]] — Holland,P.W.(1986)"StatisticsandCausalInference."JournaloftheAmerican…
...
- [[human-self-efficacy-theory|自己効力感（バンデューラ）——課題を遂行できるという自分への信念が行動の開始・持続・努力量を規定し、四つの源泉から形成される]] — Schunk,D.H.(2003).Self-efficacyforreadingandwriting:Influenceofmodeli…
- [[human-situation-awareness-endsley|エンズリーの状況認識（SA）モデル——知覚・理解・予測の三層がつくる動的意思決定の認知基盤]] — Stanton,N.A.,Stewart,R.,Harris,D.,etal.(2006)."DistributedSituationAw…
...
- [[infosoc-networked-protest-tufekci|トゥフェックチのネットワーク化された抗議——能力を伴わないシグナルの拡大と戦術的凍結]] — Bennett,W.L.,&Segerberg,A.(2012).TheLogicofConnectiveAction:DigitalMe…
