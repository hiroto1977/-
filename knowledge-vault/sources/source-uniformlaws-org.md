...
- [[bizlaw-parole-evidence-rule|口頭証拠排除法則]] — UniformLawCommission—UniformCommercialCode
- [[bizlaw-secured-transactions-ucc9|担保付取引法（UCC第9条）]] — UniformLawCommission:UCCArticle9—text,amendments,stateadoptionstatus
- [[bizlaw-trade-secret-misappropriation|営業秘密の不正取得（トレード・シークレット法）]] — UniformLawCommission(1979/1985)UniformTradeSecretsAct—UTSAtextandstat…
