...
> [!info] 出典ドメイン索引 ・ 引用 **11 件**（学術 8 ・ リファレンス 3）

## このドメインを出典とする項目

- [[econ-behavioral-theory-firm-cyert|企業の行動理論と組織的意思決定の政治経済モデル（サイアート＝マーチ）]] — Cyert&March(1963)ABehavioralTheoryoftheFirm—Prentice-Hall(2nded.1992B…
- [[infosoc-attention-ecology|注意のエコロジー（Ecology of Attention）]] — TheEcologyofAttention—Wiley
- [[infosoc-data-as-capital-sadowski|資本としてのデータ——データ収集の駆動力を資本蓄積の論理として説明するサドウスキーの理論]] — Srnicek,N.(2017).PlatformCapitalism.Polity.—プラットフォームをデータ抽出装置として分析する比較…
...
- [[infosoc-media-agenda-setting|アジェンダ設定理論（マコームズ＆ショー）——メディアは「何を考えるか」ではなく「何について考えるか」を方向づけ、争点と属性の顕出性を公衆に転写する]] — Wiley:McCombs,M.(2004)SettingtheAgenda:TheMassMediaandPublicOpinion—P…
