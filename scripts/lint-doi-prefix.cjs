...
const DUPLICATE_ID_ALLOWLIST = new Map([
  ['bernanke|1999|financial accelerator quantitative business',
    '未確定: Bernanke, B. S., Gertler, M. & Gilchrist, S. (1999) "The Financial Accelerator in a Quantitative Business Cycle Framework", in Taylor, J. B. & Woodford, M. (eds.) Handbook of Macroeconomics, Vol. 1, Part C, Ch. 21, Elsevier（書誌自体もラベル記載どおりで、独立検証はできていない）。未検証。参考情報として（検証ではなく prefix レベルの構造的観察）: 10.1016/S1574-0048(99)10034-X の 1574-0048 は Elsevier の Handbooks in Economics シリーズの ISSN 由来 prefix で Handbook 章と整合的、一方 10.1257/aer.* は American Economic Association の American Economic Review 用 prefix であり Handbook 章には付かない形。したがって econ-debt-deflation-fisher（10.1257/aer.89.5.1322）側が誤りである可能性が高いと見込まれるが、これはあくま'],
  ['citton|2017|ecology attention polity press',
    '未確定: Citton, Yves (2017) The Ecology of Attention. Cambridge: Polity Press（Barnaby Norman 訳、ISBN 978-1-5095-0372-8 / 978-1-5095-0373-5、220pp）。原著は Pour une écologie de l\'attention, Paris: Seuil, 2014。。判明した誤り: 10.4000/books.enseditions.11081 は Comolli, Jean-Louis『Cinéma, numérique, survie : L\'art du temps』ENS Éditions, Lyon, 2019（OpenEdition Books 収録）の一部（章）。著者も主題も Citton とは無関係。 / 10.3917/dec.citto.2014.01 は Citton, Yves (dir.)『L\'économie de l\'attention : Nouvel horizon du capitalisme ?』Paris: La Découverte, coll. Sciences humaines, 2014, 328p., ISBN 9782707178701。著者は同じだが、2017年 Polity の The Ecolo'],
  ['diamond|1971|optimal taxation public production',
    '未確定: Diamond, Peter A. & Mirrlees, James A. (1971) "Optimal Taxation and Public Production I: Production Efficiency." American Economic Review, 61(1), 8–27.（続編 II: Tax Rules は同巻 261–278）。両 DOI とも Diamond–Mirrlees (1971) ではない可能性がきわめて高い（どちらも 10.2307/2296xxx = Review of Economic Studies 帯で、AER 掲載論文ではありえない位置にある。かつ両者とも検索上まったく無関係な文脈＝時間非整合の選好／先物ヘッジ で引用されている）。ただし「実際に何を指すか」の確定と、正しい DOI（10.2307/1910538 と推測）の確認は未了。要追試: "10.2307/1910538" を引用符付きで検索し jstor.org/stable/1910538 の lookup が出るか確認すること。'],
  ['ezekiel|1938|cobweb theorem quarterly journal',
    '未確定: Ezekiel, Mordecai (1938) "The Cobweb Theorem." The Quarterly Journal of Economics, 52(2), 255–280.（ラベル記載の書誌。当方では未検証）。未照合（証拠ゼロ）。2 つの DOI (10.2307/2967580, 10.2307/1907330) は互いに食い違っているので少なくとも一方は誤りだが、どちらが誤りかを判定する根拠を一切持っていないため wrong は空にした。要追試: (1) "10.2307/2967580" を引用符付きで検索、(2) "10.2307/1907330" を引用符付きで検索、(3) Ezekiel 1938 "The Cobweb Theorem" Quarterly Journal of Economics jstor stable で正 DOI を特定。QJE は現在 Oxford University Press 刊なので academic.oup.com/qje/article-lookup/doi/… 形式の lookup URL が出れば強い証拠になる。'],
  ['felin|2015|microfoundations movement strategy organization',
    '未確定: Felin, Teppo, Foss, Nicolai J. & Ployhart, Robert E. (2015) "The Microfoundations Movement in Strategy and Organization Theory." Academy of Management Annals, 9(1), 575–632.（ラベル記載の書誌。当方では未検証）。未照合（証拠ゼロ）。ただしこの群は他の群と性質が異なる可能性が高く、慎重な扱いが必要: 2 つの DOI はサフィックス "19416520.2015.1007651" が完全に同一で、接頭辞だけが 10.5465（Academy of Management）と 10.1080（Taylor & Francis / Routledge）で異なる。Academy of Management Annals は当時 Routledge から刊行され後に AOM へ移管された経緯があるため、「両方とも実在し同一論文に解決する（出版社移管に伴う重複 DOI）」という可能性が十分ある。その場合はどちらも誤りではなく、正典をどちらにするかの方針判断になる。要追試: "10.5465/19416520.2015.1007651" と "10.1080/19416520.2015.1007651" をそれぞれ引用'],
  ['gereffi|2005|governance global value chains',
    '未確定: Gereffi, Gary, Humphrey, John & Sturgeon, Timothy (2005) "The Governance of Global Value Chains." Review of International Political Economy, 12(1), 78–104.（ラベル記載の書誌。当方では未検証）。未照合（証拠ゼロ）。ただし DOI の構造からの未検証の見立てを記録しておく: (a) 10.1080/09692290500049805 は T&F の命名規則 10.1080/<ISSN 数字列><年><連番> に合致し、09692290 は Review of International Political Economy の ISSN 0969-2290 と一致するため、ラベルの文献（RIPE 2005）である可能性が高い。(b) 10.1017/S0003055402004392 は Cambridge University Press の命名規則で、S0003055… は American Political Science Review の ISSN 0003-0554 に対応し、続く "02" は 2002 年を示唆する。つまり APSR 2002 年掲載の別論文とみられ、RIPE 2005 の本論文ではありえない'],
  ['huff|1990|mapping strategic thought wiley',
    '未確定: Huff, A. S. (ed.) (1990) Mapping Strategic Thought. Chichester: John Wiley & Sons（書籍）。判明した誤り: 10.1002/9781118785317 は Wiley Encyclopedia of Management (Cooper, C. L.; Flood, P. C.; Freeney, Y. 編, 2015) の書籍レベル DOI。配下の項目 DOI 群が確認できる: 10.1002/9781118785317.weom110247 (Role Transitions, Ashforth)、.weom080099 (Asset Specificity)、.weom110198 (Organizational Culture, Martin) など。Huff (1990) とは無関係。。両方とも誤り。ラベルの文献は書籍なので、正しい DOI は「存在しない」が正解の可能性が高い（1990年刊 Wiley 単行本）。ただし Wiley が後年遡及登録している可能性を排除できないため unresolved。実務的には DOI フィールドを空にし ISBN を用いる運用を推奨。'],
  ['kyle|1985|continuous auctions insider trading',
    '未確定: Kyle, A. S. (1985) "Continuous Auctions and Insider Trading", Econometrica, 53(6), 1315-1335（ラベル記載どおり。書誌自体も本セッションでは未検証）。未検証。両 DOI とも 10.2307 (JSTOR) で 1913xxx 帯＝Econometrica のレンジに見えるが、どちらが Kyle (1985) でどちらが別論文かを裏付ける証拠を一切取得していないため、誤り判定を保留する。検索予算を回復のうえ "10.2307/1913210" / "10.2307/1913732" を引用符付きで再検索し、jstor.org/stable/ または www.jstor.org の lookup URL でタイトルを確認すること。'],
  ['ocasio|1997|towards attention based view',
    '未確定: Ocasio, William (1997) "Towards an Attention-Based View of the Firm"（掲載誌がエントリ間で食い違う：一方は Strategic Management Journal 18(S1), 187–206 を示唆する DOI、他方はラベルで Organization Science と記載）。未確認事項：もう一方の 10.1002/(SICI)1097-0266(199707)18:1+<187::AID-SMJ936>3.0.CO;2-K は SICI 形式で ISSN 1097-0266（Strategic Management Journal）、1997年7月、18巻 suppl.1、開始頁 187 を符号化しており、SMJ 18(S1) 187–206 という書誌と構造的に整合する。ただし出版社ページでの独立検証ができていないため correctDoi には採用していない（推測での確定を禁じられているため）。判定を確定させるには (1) "10.1002/(SICI)1097-0266(199707)18:1+<187::AID-SMJ936>3.0.CO;2-K" の引用符付き検索で onlinelibrary.wiley.com の lookup URL を確認、(2) Organization Sc'],
  ['ramsey|1927|contribution theory taxation economic',
    '未確定: Ramsey, F. P. (1927) "A Contribution to the Theory of Taxation", The Economic Journal 37(145), 47–61。未確認。推測での確定を避けるため、どちらのエントリを誤りとするかの判定は行わない。次セッションでの必要作業：(1) "10.2307/2222721" を引用符付きで検索し、Economic Journal 37(145) 47–61 の Ramsey 論文に対応する lookup URL（academic.oup.com/ej/article-lookup/... または jstor.org/stable/2222721）が出るか確認、(2) "10.2307/2228016" を同様に検索して別文献（同じく Economic Journal の JSTOR ID 帯と思われる）を同定する。参考として Wiley/OUP 側の別名 DOI（10.2307 以外）が存在する可能性も併せて確認すること。'],
  ['sen|1970|collective choice social welfare',
    '未確定: Sen, Amartya K. (1970) Collective Choice and Social Welfare, San Francisco: Holden-Day（後に 1979 North-Holland 版、2017 Harvard University Press 拡張版）。判明した誤り: 10.1017/CBO9780511558726 は Parry, Geraint; Moyser, George; Day, Neil (1992) Political Participation and Democracy in Britain, Cambridge University Press（全く別の書籍） / 10.1093/0198281935.001.0001 は Sen, Amartya (with James Foster) On Economic Inequality（Oxford University Press、1973 初版／1997 拡張版、Oxford Scholarship Online）。著者は同じだが別の書籍。。両方とも誤り。1970 年 Holden-Day 版には DOI が存在しない可能性が高い（当時の単行本には DOI 付与が一般的でない）。正しい書誌参照としては ISBN もしくは後年版の DOI（2017 Harvar'],
  ['srnicek|2017|platform capitalism polity press',
    '未確定: Srnicek, Nick (2017) Platform Capitalism, Cambridge: Polity Press（Theory Redux シリーズ）。判明した誤り: 10.2307/j.ctv5cgbnk は Garnaut, Ross; Song, Ligang; Cai, Fang (eds.) China\'s 40 Years of Reform and Development: 1978-2018, ANU Press（JSTOR 収録の書籍。31 章構成） / 10.1111/1467-954X.12408 は Ellis, A. (2016) 書評: Winlow, Hall, Treadwell & Briggs, \'Riots and Political Protest: Notes from the Post-Political Present\' (Routledge, 2015), The Sociological Review, 64, 595-597（書籍ではなく書評記事）。4 件すべて誤り（少なくとも Srnicek の書籍ではない）と判定。うち 2 件は実体を特定、2 件は JPPM 論文であること以外は未特定。正しい DOI が存在するか自体が未確認のため unresolved とした。Polity 刊行の短編理論書は D'],
  ['tarafdar|2007|impact technostress role stress',
    '未確定: Tarafdar, Monideepa; Tu, Qiang; Ragu-Nathan, Bhanu S.; Ragu-Nathan, T. S. (2007) "The Impact of Technostress on Role Stress and Productivity", Journal of Management Information Systems, 24(1), 301-328（リポジトリ側 src/renderer/data/academicKnowledge.ts の infosoc-technostress-theory エントリの sources ラベルより。ただしこれは監査対象データ自身であり外部証拠ではない）。未確認事項（次回の再実行で必須）: (1) 10.2753/MIS0742-1222240109 — 書式上は M.E. Sharpe / Taylor & Francis の Journal of Management Information Systems（ISSN 0742-1222）第24巻第1号第09論文に対応し、ラベルの文献と整合的に見えるが未検証。(2) 10.1111/j.1540-5915.2007.00161.x — 書式上は Wiley の Decision Sciences 誌 2007 年論文の DOI だが'],
  ['viner|1950|customs union issue carnegie',
    '未確定: Viner, Jacob (1950). The Customs Union Issue. New York: Carnegie Endowment for International Peace（Studies in the Administration of International Law and Organization, No. 10）. 単行本。。両 DOI とも「Viner の書籍ではない可能性が高い」（JSTOR 数字型 DOI は雑誌論文用で、書籍は 10.2307/j.ctt… 形式）が、実際に何を指すのかは確認できず、正しい DOI も確認できなかったため unresolved。書籍→論文の取り違えの疑いが濃厚。要追加調査：JSTOR stable/2226521 と stable/2550651 の実体、および Viner 書籍の復刻版 DOI の有無。'],
  ['wajcman|2004|technofeminism polity press',
    '未確定: Wajcman, Judy (2004). TechnoFeminism. Cambridge / Malden, MA: Polity Press. viii+148 pp. ISBN 0-7456-3043-X。単行本。。判明した誤り: 10.1017/CBO9780511816208 は Crawford, Harriet. Sumer and the Sumerians, 2nd edition. Cambridge University Press（印刷版 2004、電子版 eISBN 9780511816208）。考古学・中東研究の書籍。。10.1017/CBO9780511816208 が全く別の書籍（Sumer and the Sumerians）であることは Cambridge のページで確定。10.1093/0199247269.001.0001 は OUP の別書籍であることは形式から確実だが書名は未特定。正しい DOI が存在しない（＝DOI 欄自体を空にすべき）可能性が高く、その場合は「両方とも誤り」の群。unresolved としたのは正 DOI を提示できないため。'],
  ['zuboff|2019|surveillance capitalism publicaffairs',
    '未確定: Zuboff, Shoshana (2019). The Age of Surveillance Capitalism: The Fight for a Human Future at the New Frontier of Power. New York: PublicAffairs（Hachette Book Group）. 単行本。。判明した誤り: 10.1017/9781108680202 は Cambridge University Press の別書籍。埋め込まれた eISBN 9781108680202 は書店掲載では Handbook of Industrial Crystallization（Cambridge）に対応。ただし Cambridge 公式ページでの確認は取れておらず、書名の確度は中程度。いずれにせよ Cambridge 刊の書籍であり PublicAffairs の本書ではない。 / 10.1515/9781610396196 は 埋め込まれた ISBN 9781610396196 は Taylor, Paul & Pew Research Center (2014) The Next America: Boomers, Millennials, and the Looming Generational Showdown（PublicAff'],
]);
