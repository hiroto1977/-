...
const MOCK_ITEMS: FundingItem[] = [
  ...
  { id: 'f-bank', kind: 'loan', name: '民間金融機関 運転資金融資', amount: 10_000_000, status: 'received', month: '2026-02', repayable: true },
  { id: 'f-jfc-startup', kind: 'jfc', name: '公庫 新規開業資金', amount: 6_000_000, status: 'approved', month: '2026-05', repayable: true },
