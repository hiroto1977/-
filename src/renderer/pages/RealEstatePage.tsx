...
export function RealEstatePage() {
  ...
  /**
   * **月次経費・月次返済が読めず 0 として差し引いた**ことの断り (パス 446)。
   * この 2 欄だけが黙っており、手残りを**過大**に見せていた。
   */
  const costNote = useMemo(() => unreadableCostNote(portfolio), [portfolio]);
  ...
  return (
    <div>
      ...
      <Section title="ポートフォリオ KPI" count={4}>
        ...
        {(yieldNote !== null || rentNote !== null || mixNote !== null || costNote !== null) && (
          <div
          ...
          >
            ...
            {/* **月次キャッシュフローが過大に出ている**ことを言う (パス 446)。 */}
            {costNote !== null && <div data-portfolio-cost-unreadable>⚠ {costNote}</div>}
          </div>
        )}
      </Section>
