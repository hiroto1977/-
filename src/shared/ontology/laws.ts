...
export const LAWS: readonly Law[] = [
  ...
  },
  {
    ...
    provenance: ['パターン 0-a-7', 'パス 467 (読めない台帳が「空」として緑になり、37 ゲート全部が素通りした)', 'パス 468 (母集団を空にして測ると、33 ゲートのうち 5 本が exit 0 だった)', 'パス 469 (床は 0 件にしか当たらない —— .tsx が消えても 5 本が exit 0 だった)'],
    enforcedBy: [
