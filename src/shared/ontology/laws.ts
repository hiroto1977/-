...
export const LAWS: readonly Law[] = [
  ...
  },
  {
    ...
    family: 'single-rule',
    name: '弱さを仕様として書き留めない',
    statement: '検査の題名が「前置き一致なので弾く側」「Never throws」と弱さに名前を与えると、落ちる検査が無くなり読んで気付くしかない。弱さは閉じるか、理由つきの台帳に「閉じていない物」として書く。',
    provenance: ['パス 291', 'パス 309'],
    enforcedBy: [prose(HANDOFF, '題名の意味は機械に映らない。各パスの「閉じていない物」の節がその台帳')],
  },
