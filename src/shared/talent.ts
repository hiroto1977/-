...
/** 出典の強さ。`confirmed` = 著者側の解説を確認済み / `gloss` = 名称のみ確認で語釈は読み解き。 */
export type SourceStrength = 'confirmed' | 'gloss';
...
export const ORGAN_DISEASES: readonly OrganDisease[] = [
  ...
  },
  {
    id: 'shrinking',
    name: '職務の矮小化現象',
    summary: '職務の範囲が、本人の中で少しずつ小さくなっていく。',
    source: 'gloss',
  },
  {
    id: 'number-worship',
    name: '数字万能病',
    summary: '数字さえ追えばよいとなり、数字の背後にある意味が失われる。',
    source: 'gloss',
  },
  {
    id: 'format-trust',
    name: 'フォーマット過信病',
    summary: 'フォーマットを埋めること自体が目的化する。',
    source: 'gloss',
  },
];
...
/** 業務スキルの習得目安の上限 (年)。これを超えて STEP1 に留まっていたら配置を疑う。 */
